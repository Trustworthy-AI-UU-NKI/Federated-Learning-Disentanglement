...
class MISSFormer(nn.Module):
    def __init__(self, num_classes=1, token_mlp_mode="mix_skip", image_size=224, encoder_pretrained=True):
        super().__init__()
        ...
        self.backbone = MiT(image_size, dims, layers,token_mlp_mode)
